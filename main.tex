...
\author{Caesario, Muhammad Abyan Farhan }
...
\begin{document}
  ...
  \input{sampul/sampul-luar-in.tex}
  \cleardoublepage
  % Sampul Bahasa Inggris
  \newcommand\covercontentsen{sampul/konten-en.tex}
  \input{sampul/sampul-luar-en.tex}
  \cleardoublepage
 ...
 %\cleardoublepage
  ...
  % Konten lainnya
	\input{konten/5-Kesimpulan dan saran.tex}
